package com.evcharging.app.presentation.ui.dashboard
...
import com.evcharging.app.databinding.FragmentDashboardBinding
import com.evcharging.app.domain.model.ChargingStation
import com.evcharging.app.presentation.ui.booking.BookingActivity
import com.evcharging.app.presentation.ui.station.StationDetailActivity
...
class DashboardFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun setupObservers() {
        ...
        viewModel.user.observe(viewLifecycleOwner) { user ->
            user?.let {
                ...
                if (user.role == com.evcharging.app.domain.model.UserRole.Operator) {
    ...
    private fun updateDashboardUI(data: com.evcharging.app.domain.model.DashboardData) {
        binding.apply {
    ...
    private fun setupOperatorFeatures() {
        binding.apply {
            btnScanQR.setOnClickListener {
                ...
                startActivity(Intent(requireContext(), com.evcharging.app.presentation.ui.qr.QRScannerActivity::class.java))
            }
